...
import tournament.BracketImpl_Westby;
...
public class BracketTests_WorldCup2014_SUBSET_FOR_STUDENTS
{
	...
	public void setUp()
	{
		...
		worldCup2014KnockoutResults = new BracketImpl_Westby<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups);
		...
		worldCup2014KnockoutResults_ALT = new BracketImpl_Westby<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups_ALT);
		...
		worldCup2014KnockoutResults_NETHERLANDS_WINS_INSTEAD = new BracketImpl_Westby<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups_ALT);
		...
		worldCup_DEGENERATE = new BracketImpl_Westby<FIFASoccerTeam>(matchups_DEGENERATE);
	}
